package com.innocodes.EWalletAPIwithSpringBoot.security;
...
public class JwtUtil {
    ...
    public String generateToken(UserDetails userDetails) throws ValidationException {
    ...
    public String generateRefreshToken(UserDetails userDetails) throws ValidationException {
        User user = userRepository.findByEmail(userDetails.getUsername())
                .orElseThrow(() -> new ValidationException("error generating token"));
        Map<String, Object> claims = new HashMap<>();
        claims.put("uuid", user.getUuid());
